...
<div class="plans-section">
	<div class="plans-main">
		<h1 class="w3l-inner-h-title">Diamond Pricing Tables</h1>
				 <div class="price-grid" style="width:50%">
				...
				<div class="price-grid" style="width:20%">
...
<div class="copyright-agile">
	<p>&copy; 2017 Diamond Pricing Tables. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
</div>
<!-- //copyright -->

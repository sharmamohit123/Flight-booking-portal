...
<div class="header-main" id="id03">
		<h2>Change Password</h2>
			<div class="header-bottom">
				<div class="header-right w3agile">
					<div class="header-left-bottom agileinfo">
						<form action="/action_pass.php" method="post" id="id04">
							<div class="icon1">
								<input type="password" placeholder="Type old password" required="" name="old" />
							</div>
							<div class="icon1">
								<input type="password" placeholder="Type new password" required="" name="new1" />
							</div>
                            <div id="err1">
                               
                            </div>
                            <div class="icon1">
								<input type="password" placeholder="Re-Type new password" required="" name="new2" />
							</div>
							<div class="bottom">
								<input type="submit" value="Save" />
                                <button type="button" onclick="cancel2()">Cancel</button>
							</div>
    ...
    <script>
        function cancel2(){
            document.getElementById('id04').reset();
